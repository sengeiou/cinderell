...
public class CategoryHomeListAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    ...
    protected void convert( BaseViewHolder helper,  String item) {
        ...
        mAdapter.setNewData(position%3==1? DataUtil.getData(6): DataUtil.getData(6));
