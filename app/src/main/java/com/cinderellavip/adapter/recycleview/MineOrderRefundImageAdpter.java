...
public class MineOrderRefundImageAdpter extends BaseQuickAdapter<OrderCommentImageItemBean, BaseViewHolder> {
    ...
    int number;
    public MineOrderRefundImageAdpter(OnPublishImageListener listener, int parentPosition, int number) {
