            ...
            public void clickView(View view, int position, int type) {
                ...
                switch (type) {
                    ...
                    case SobotPicListAdapter.PIC:
                        ...
                        Intent intent = new Intent(SobotReplyActivity.this, SobotPhotoListActivity.class);
                    ...
                    case SobotPicListAdapter.DEL:
                        if (seleteMenuWindow == null) {
                            seleteMenuWindow = new SobotDeleteWorkOrderDialog(SobotReplyActivity.this, ResourceUtils.getResString(SobotReplyActivity.this, "sobot_do_you_delete_picture"), new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
